...
const handleSubmit = () => {
    window.location.href = "/auth-two-step-verification-basic"
};
</script>
<template>
    <div
            ...
            <div class="grid grid-cols-12">
                <div
                    ...
                    <div class="md:p-10 card-body">
                        ...
                        <p class="mb-5 text-center text-gray-500 dark:text-dark-500">Enter your email or username to
                            reset it.</p>
                        ...
                        <form @submit.prevent="handleSubmit">
                            <div class="grid grid-cols-12 gap-4 mt-5">
                                <div class="col-span-12">
                                    ...
                                    <input v-model="emailOrUsername" type="text" id="emailInput"
                                        class="w-full form-input" placeholder="Enter your email or username" required />
                                </div>
                                <div class="col-span-12">
                                    <button type="submit"
                                        class="w-full px-4 py-2 text-white rounded-md bg-primary-500 hover:bg-primary-600">Reset
                                        Password</button>
                                    <p class="mt-3 text-center text-gray-500 dark:text-dark-500">
                                        Return to the <router-link to="/auth-signin-basic"
                                            class="font-medium underline link link-primary"><span
                                                class="mr-1 align-middle">Sign In</span>
                                            <MoveRight class="inline-block rtl:mr-1 ltr:ml-1 size-4"></MoveRight>
                                        </router-link>
                                    </p>
                                </div>
                            </div>
