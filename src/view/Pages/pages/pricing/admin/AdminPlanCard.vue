...
import { TrendingDown, TrendingUp, UserRound } from 'lucide-vue-next';
...
<template>
    <div class="relative overflow-hidden card">
                    ...
                    <g id="&lt;Clip Group&gt;" clip-path="url(#cp1)">
                        <g id="&lt;Group&gt;">
                            <g id="all 10">
                                <g id="&lt;Group&gt;">
                                    <g id="shape 10 1">
                                        <path id="&lt;Compound Path&gt;" fill-rule="evenodd" :class="bgColor"
        ...
        <div class="relative card-body">
            <h6 class="uppercase text-14">{{ title }}</h6>
            <div class="flex items-center justify-center h-32">
                <div>
                    <TrendingUp v-if="growth > 0" class="mx-auto mb-2 text-green-500 size-7"></TrendingUp>
                    <TrendingDown v-else class="mx-auto mb-2 text-red-500 size-7"></TrendingDown>
                    <h3> <span v-if="growth > 0">+</span>{{ growth }}%</h3>
                </div>
            </div>
            <h6>
                <UserRound data-lucide="user-round" class="inline-block ltr:mr-1 rtl:ml-1 size-4 mb-0.5"></UserRound>
                {{ users }}
            </h6>
        </div>
    </div>
