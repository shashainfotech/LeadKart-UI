...
const contacts: Contact[] = [
  { name: "Shopia Mia", initial: "S", badge: 5 },
  {
    name: "Windows Social Media",
  ...
  {
    name: "Romero",
    image: new URL("@/assets/images/brands/img-17.png", import.meta.url).href,
  },
  {
    name: "Romero",
    image: new URL("@/assets/images/brands/img-16.png", import.meta.url).href,
  },
];
...
const emailData = ref<Array<Email>>([
  {
    id: 1,
    sender: "Armand Noto",
    ...
    replies: [
      {
        ...
        message:
          "Thanks, Armand. The status looks good. Let's discuss the next steps in our upcoming meeting.",
      },
    ],
  },
  {
    ...
    message:
      "Thank you, Shopia, for always believing in our subscriptions. As a token of appreciation, here is a voucher that you can use in our application.",
    avatarImage: user13,
    ...
    replies: [
      {
        ...
        message:
          "Thank you, Sherry! I appreciate the gesture. I'll definitely use the voucher.",
      },
    ],
  },
  {
    ...
    replies: [
      {
        ...
        message:
          "Thank you, Joyce! I’d love to discuss your wedding plans further.",
      },
    ],
  },
  {
    ...
    replies: [
      {
        ...
        message:
          "Thanks, Walter. I'll review the proposal and get back to you soon.",
      },
    ],
  },
  {
    ...
    replies: [
      {
        ...
        message:
          "Looks good, Emily. I have a few suggestions, let's discuss them.",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    message:
      "Please find the weekly update attached. Let me know if you need any more details.",
    avatarImage: user17,
