...
const theme = computed(() => layoutStore.layoutTheme);
...
const treeData = ref({
    ...
    children: [
            ...
            children: [
                {
                    ...
                    options: {
                        nodeBGColor: colorCodes.value[9],
                        nodeBGColorHover: colorCodes.value[9],
                    },
                },
            ],
        },
        {
            ...
            options: {
                nodeBGColor: colorCodes.value[10],
                nodeBGColorHover: colorCodes.value[10],
            },
        },
    ],
});
...
<template>
    <PageHeading title="Left to Right" sub-title="Apextree" />
    <div class="grid grid-cols-12 gap-x-space">
        <Card title="Left to Right" :full-width="true">
            <div class="border rounded-md border-gray-200 dark:!border-dark-800">
                <div ref="apexTreeContainer" class="w-full" :style="{ height: '700px' }"></div>
            </div>
        </Card>
    </div>
</template>
