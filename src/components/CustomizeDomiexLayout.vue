...
const selectedLayout = ref(layoutStore.layoutStyle);

const setLayout = (layout: string) => {
    selectedLayout.value = layout
    setNavigation('default')
//     store.dispatch('updateLayoutStyle', layout);
    layoutStore.updateLayoutStyle(layout);
...
const navType = ref(layoutStore.navigationType);
...
//     store.dispatch('updateNavType', type);
    layoutStore.updateNavType(type);
    navType.value = type
...
const layoutDir = ref(layoutStore.layoutDir);
...
//     store.dispatch('updateLayoutDir', direction);
    layoutStore.updateLayoutDir(direction);
...
//     store.dispatch('updateDarkModeColors', color);
    layoutStore.updateDarkModeColors(color);
};

// =========== sidebar color ===================
// const selectedSidebarColor = ref(store.getters.sidebarColor);
const selectedSidebarColor = ref(layoutStore.sidebarColor);
...
//     store.dispatch('updateSidebarColor', color);
    layoutStore.updateSidebarColor(color);
...
const selectedPrimaryColor = ref(layoutStore.primaryColor);
...
//     store.dispatch('updatePrimaryColor', color);
    layoutStore.updatePrimaryColor(color);
