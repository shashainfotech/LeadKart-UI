...
const currentLocale = ref(layoutStore.language);
const changeLanguage = () => {
    locale.value = currentLocale.value;
//     store.dispatch('updateLanguage', currentLocale.value);
    layoutStore.updateLanguage(currentLocale.value);
...
const layout = computed(() => layoutStore.layoutStyle) // for horizontal or not check
// const sidebarSize = ref(store.getters.sidebarSize);
const sidebarSize = ref(layoutStore.sidebarSize);
...
//         store.dispatch('updateSidebarVisibleValue', true);
        layoutStore.updateSidebarVisibleValue(true);
...
//             store.dispatch('updateSidebarSize', sidebarSize.value);
            layoutStore.updateSidebarSize(sidebarSize.value);
        };
